...
export const INITIAL_HOSTELS: Hostel[] = [
  ...
  },
  {
    ...
    area: 'Roma',
    distanceMeters: 350,
    description: 'Located at Roma Commercial Area. Features instant street-access to printing facilities, local cafeterias, and cyber cafés. It offers top-quality concrete finishes and an efficient security system.',
    securityRating: 4,
    hasBorehole: true,
    hasWifi: true,
    hasHotShower: true,
  ...
  },
  {
    ...
    area: 'Roma',
    distanceMeters: 400,
    description: 'A highly secure and modern apartment-style hostel situated in Roma. Offers spacious rooms with elegant floor tiles, constant water supply from a borehole, high-speed internet routers, and instant hot showers.',
    securityRating: 4,
    hasBorehole: true,
    hasWifi: true,
    hasHotShower: true,
  ...
  },
  {
    ...
    area: 'Roma',
    distanceMeters: 360,
    description: 'An iconic and vibrant red-accented student mansion in Roma. Famed for its lively student-friendly ambiance, 24/7 watchman support, hot shower systems, and very stable internet connection.',
    securityRating: 4,
    hasBorehole: true,
    hasWifi: true,
    hasHotShower: true,
  ...
  },
  {
    ...
    area: 'Roma',
    distanceMeters: 300,
    description: 'Popular with digital-first comrades, offering ultra-high bandwidth fiber internet in Roma. Strategically close to cyber centers, quick-dining kiosks, and photocopy booths. Backed by solid water and security grids.',
    securityRating: 4,
    hasBorehole: true,
    hasWifi: true,
    hasHotShower: true,
